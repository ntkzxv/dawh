...
import { optionalText, rejectUnknownFields, requiredBigIntId, requiredText } from "@/lib/core/validation/fields";
...
export function parseAssignRole(body: Record<string, unknown>): AssignRoleInput {
